...
export const env = {
  ...
  AIRALO_AFFILIATE_ID: process.env.AIRALO_AFFILIATE_ID || '',
  CHAPKA_AFFILIATE_URL: process.env.CHAPKA_AFFILIATE_URL || '',
  MONDIAL_ASSISTANCE_URL: process.env.MONDIAL_ASSISTANCE_URL || '',
  WELCOMEPICKUPS_AFFILIATE_URL: process.env.WELCOMEPICKUPS_AFFILIATE_URL || '',
